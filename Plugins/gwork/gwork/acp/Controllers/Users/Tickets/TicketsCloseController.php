<?php
	...
	namespace Plugins\gwork\gwork\acp\Controllers\Users\Tickets {
	    ...
	    final class TicketsCloseController extends Controller implements IRoute {
	        ...
	        public function onCall(Route $route, array $vars) {
				...
				if($route->getName() == 'admin-users-tickets-close') {
	        ...
	        public function getRoutes(): array {
	            return [
		            new Route('/admin/users/tickets/close/{int:id}', $this, 'admin-users-tickets-close', true)
	            ];
	        }
	    }
