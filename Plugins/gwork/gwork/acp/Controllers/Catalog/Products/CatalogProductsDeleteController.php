<?php
	...
	namespace Plugins\gwork\gwork\acp\Controllers\Catalog\Products {
	    ...
	    final class CatalogProductsDeleteController extends Controller implements IRoute {
	        ...
	        public function onCall(Route $route, array $vars) {
				...
				if($route->getName() == 'admin-catalog-products-delete') {
	        ...
	        public function getRoutes(): array {
	            return [
		            new Route('/admin/catalog/products/delete/{int:id}', $this, 'admin-catalog-products-delete', true)
	            ];
	        }
	    }
