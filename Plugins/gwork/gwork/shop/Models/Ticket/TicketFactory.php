<?php
	...
	namespace Plugins\gwork\gwork\shop\Models\Ticket {
	    ...
	    final class TicketFactory extends AbstractFactory {
			/**
	        ...
	        public function __construct(ModelsManager $modelsManager, PDO $connection) {
	            ...
	            parent::__construct($modelsManager, $connection, $prefix . 'tickets');
	        }

			/**
			 * @see GWork\System\Patterns\MVC\Models\AbstractFactory::create()
			 */
	        public function create($row): Ticket {
	            return new Ticket($row, $this->getConnection(), $this->getModelsManager(), $this->getTable());
	        }
	    }
	}
