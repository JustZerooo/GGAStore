<?php
	...
	namespace Plugins\gwork\gwork\shop\Models\Product {
	    ...
	    final class ProductFactory extends AbstractFactory {
	        ...
	        public function __construct(ModelsManager $modelsManager, PDO $connection) {
	            ...
	            parent::__construct($modelsManager, $connection, $prefix . 'products');
	        }

			/**
			 * @see GWork\System\Patterns\MVC\Models\AbstractFactory::create()
			 */
	        public function create($row): Product {
	            return new Product($row, $this->getConnection(), $this->getModelsManager(), $this->getTable());
	        }
	    }
	}
